...
router.get("/<v:version_id", versions_middleware.set_param_lt, versions_controller.get_versions_by_version); // Display before specified version

router.get("/>v:version_id", versions_middleware.set_param_gt, versions_controller.get_versions_by_version); // Display after specified version

router.get("/<d:download_date", versions_middleware.set_param_lt, versions_controller.get_versions_by_date); // Display before specified date

router.get("/>d:download_date", versions_middleware.set_param_gt, versions_controller.get_versions_by_date); // Display after specified date

// POST routes

router.post("/add/v:version_id", versions_controller.add_version); // Add new version

router.post("/add/p:version_id-:property_id", versions_controller.add_property); // Add new property to version
